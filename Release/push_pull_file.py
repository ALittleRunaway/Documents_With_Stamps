...
class PushPullFile():
    ...
    def push_pull_file(arguments):
        ...
        # Check wether it is a url or a link to the shared folder
        if "http" in arguments["take_path"]:
            ...
            shutil.copyfile(arguments["take_path"], os.path.join("input_files", filename))
